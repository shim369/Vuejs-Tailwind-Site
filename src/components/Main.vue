<template>
    <main>
      <section id="concept" class="p-12 bg-white">
        <h2 class="text-center text-3xl mb-4 tracking-widest text-seaBlue">沖縄の飲食店を応援する</h2>
        <p class="text-center text-sm leading-8 text-seaBlue mb-4">新型コロナウィルスによって多くの飲食店が大きなダメージを受けました。<br>そんな中でも一生懸命、お客さんに美味しい料理を提供してくれるお店を応援したいと考えています。</p>
